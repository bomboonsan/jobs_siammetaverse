                ...
                <div class="post_page_wrapper flex flex-wrapp gap-8">
                    ...
                    <div class="basis-full md:basis-1/2">
                        <div class="form-post-area bg-white px-4 py-4 md:px-9 md:py-9 rounded-2xl shadow-xl overflow-hidden">
                            ...
                            @endif
                            <h2 class="mb-4 font-bold text-black text-2xl">ระบุรายละเอียด</h2>
                            <form class="flex flex-wrap" action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="basis-full mb-6">
                                    ...
                                    <input type="text" name="name" class="w-full rounded-lg border border-neutral-300/50 shadow placeholder:text-neutral-300" placeholder="ระบุหัวข้องานที่ทำ"></input>
                                </div>
                                <div class="basis-full mb-6">
                                ...
                                <div class="basis-full mb-6">
                                    ...
                                    <textarea id="tinymce-editor" rows="5" cols="40" class="tinymce-editor rounded-lg border border-neutral-300/50 shadow" name="description"></textarea>
                                </div>                                
                                <div class="basis-1/2 pr-8 mb-6 w-full">
                                    ...
                                    <input type="number" class="px-5 py-1.5 w-full border-1 border-neutral-300 rounded-lg shadow text-center" name="price" id="exampleFormControlTextarea3" rows="2"  placeholder="0"></input>
                                </div>
                                ...
                                <div class="basis-full mb-6">
                                    <input type="text" name="author_name" class="px-5 py-3 w-full border-1 border-neutral-200 rounded-lg shadow" id="exampleFormControlInput1" placeholder="ชื่อ นามสกุล">
                                </div>
                                <div class="basis-full mb-6">
                                    <div class="flex flex-wrap items-center mb-3">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="author_facebook" class="px-5 py-2 w-full border-1 border-neutral-200 rounded-lg shadow" id="exampleFormControlInput1" placeholder="URL">
                                        </div>
                                    </div><!--contact-item-->
                                    <div class="flex flex-wrap items-center mb-3">
                                        <div class="flex-initial mr-4 flex-initial text-5xl text-[#333] hover:text-blue-600">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="author_line" class="px-5 py-2 w-full border-1 border-neutral-200 rounded-lg shadow" id="exampleFormControlInput1" placeholder="URL">
                                        </div>
                                    </div><!--contact-item-->
                                    <div class="flex flex-wrap items-center mb-3">
                                        <div class="flex-initial mr-4 flex-initial text-5xl text-[#333] hover:text-blue-600">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="author_email" class="px-5 py-2 w-full border-1 border-neutral-200 rounded-lg shadow" id="exampleFormControlInput1" placeholder="URL">
                                        </div>
                                    </div><!--contact-item-->
                                    <div class="flex flex-wrap items-center mb-3">
                                        <div class="flex-initial mr-4 flex-initial text-5xl text-[#333] hover:text-blue-600">
                                        ...
                                        <div class="flex-1">
                                            <input type="text" name="author_telephone" class="px-5 py-2 w-full border-1 border-neutral-200 rounded-lg shadow" id="exampleFormControlInput1" placeholder="URL">
                                        </div>
                                    </div><!--contact-item-->
                            ...
                            <script src="https://cdn.tiny.cloud/1/4fla12n1ka99a6mcv6xq37tac120tvix3e6fcb1dk9qczbl8/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>  
