...
@section('content')
            <main class="container max-w-screen-xl mx-auto mb-9">
                <h2 class="text-2xl text-neutral-800 font-medium mb-4 mt-3"><i class="fa-solid fa-clipboard-list text-2xl mr-2 text-blue-700 relative top-0"></i>{{ $categorys[0]->name }} <span class="inline-block ml-3 text-base text-neutral-500 font-light relative bottom-0.5">( {{ $counter }} )</span></h2>
